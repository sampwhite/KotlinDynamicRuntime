 ...
 *  term, the include-users flag, and the sort column and direction (#666, #668) -- not trait search fields, and
 *  never shown as one; the user and client scopes have their own controls. */
