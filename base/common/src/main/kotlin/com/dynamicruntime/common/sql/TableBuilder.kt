 ...
 * table's protocol columns are injected: the audit columns ([PF.createdBy]/[PF.updatedBy]/[PF.createdAt]/
 * [PF.updatedAt]) on every table, plus the feature columns for any opted-in [TableFeature].
 */
class TableBuilder(
    val cxt: KdrCxt,
